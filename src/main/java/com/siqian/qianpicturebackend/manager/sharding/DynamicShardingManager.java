package com.siqian.qianpicturebackend.manager.sharding;
...
/**
 * 动态分表管理器， 用于初始化和更新 ShardingSphere 的 actual-data-nodes 配置
 */
//@Component
@Slf4j
public class DynamicShardingManager {
    ...
    private void updateShardingTableNodes() {
        // 获取所有表名的set集合 picture_0001、picture_0002、picture_0003
        Set<String> tableNames = fetchAllPictureTableNames();
        String newActualDataNodes = tableNames.stream()
                .map(tableName -> "qian_picture." + tableName) // 确保前缀合法
    ...
    /**
     * 获取 ShardingSphere ContextManager: ShardingSphere 的核心上下文管理器，包含了所有的元数据和规则配置
     */
